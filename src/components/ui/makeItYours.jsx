...
export default function MakeItYours() {
  return (
    <section className="make-section">
      <div className="make-glass">
        {/* LEFT — VECTOR */}
        <div className="make-vector">
          <svg
            width="480"
            height="450"
          ...
          >
            ...
            />
            <path
              d="M268.96506,285.61915v67.8271c0,1.39153-.18991,2.75102-.55352,4.03177h-82.35691c-7.47836,0-13.53392-6.05556-13.53392-13.53392v-59.28956c0-7.69954,6.41918-13.85006,14.1191-13.53392l77.39218,3.3362c3.0355,2.75102,4.93308,6.73531,4.93308,11.16234Z"
              fill="#374bfcff"
            />
            <rect
              x="281.18228"
            ...
            <circle cx="209.6755" cy="198.582" r="5.53369" fill="#fff" />
            <path
              d="M463.55009,602.63742l137.42506,36.30253-32.33986,45.5855-120.73288-35.08699c-11.15079,5.7798-25.69994,7.01717-39.97978,2.24279-24.98602-8.35396-39.63642-31.88883-32.72285-52.56694,6.91365-20.67808,32.77305-30.66869,57.75914-22.31471,14.27992,4.7744,25.15887,14.51398,30.59116,25.83782Z"
              fill="#ed9da0"
            />
            <path
              d="M737.02762,447.39957s-6.00261,263.63664-91.97079,254.84464c-85.96818-8.79201-114.42717-19.85939-114.42717-19.85939,0,0-17.3916-66.40431,12.64844-67.98536,30.04004-1.58105,69.24277-8.97626,69.24277-8.97626v-191.20858"
              fill="#374bfcff"
            />
          </svg>
        </div>
        ...
        <div className="make-content">
          ...
          <p>
            Hi there I am Gulshan, As you seen this design can make your brand
            look premium and help you stand out in Market. Don&apos;t be late or
            miss this opportunity just contact to grab.
          </p>

          <a href="tel:+916239750926" className="contact-btn">
            <span className="phone-icon">
              ...
              >
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.8 19.8 0 0 1 3 5.18 2 2 0 0 1 5 3h3a2 2 0 0 1 2 1.72c.12.9.32 1.77.57 2.6a2 2 0 0 1-.45 2L9.1 10.9a16 16 0 0 0 4 4l1.58-1.02a2 2 0 0 1 2-.45c.83.25 1.7.45 2.6.57A2 2 0 0 1 22 16.92z" />
              </svg>
            </span>
            <span className="phone-text">+91 62397 50926</span>
          </a>
        </div>
      </div>
    </section>
